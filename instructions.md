...
- Shared `bitcoind` package id with Bitcoin Core — you can switch here from Bitcoin Core, or from Bitcoin Knots (Legacy) as carried over from StartOS 0.3.5.1, without re-syncing the chain. Bitcoin Knots (RDTS) follows a different chain and cannot switch here.
